...
func GetIACSupplier(configs []config.SupplierConfig, library *terraform.ProviderLibrary, backendOpts *backend.Options, resourceSchemaRepository *resource.SchemaRepository) (resource.Supplier, error) {
