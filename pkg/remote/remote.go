...
func Activate(remote, version string, alerter *alerter.Alerter,
	...
	case aws.RemoteAWSTerraform:
		return aws.Init(version, alerter, providerLibrary, supplierLibrary, remoteLibrary, progress, resourceSchemaRepository, factory)
	case github.RemoteGithubTerraform:
		return github.Init(version, alerter, providerLibrary, supplierLibrary, remoteLibrary, progress, resourceSchemaRepository, factory)
	default:
